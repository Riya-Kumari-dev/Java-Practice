...
// maxHeap can be visualized as a complete binary tree having node's val is less than it's both the children.
...
public class ImplementMaxHeapByArray {
    static void main(String[] args) {
        MaxHeap pq = new MaxHeap(15);
        try{
            ...
            pq.add(-2);
            pq.add(-4);
            pq.display(); // [23, 21, 4, -3, 1, 0, -2, -4]
            System.out.println(pq.peek()); // 23
